...
app.factory("Locale", function() {
	...
	Locale.langMap["cn"] = {
		...
		DOTA_ABILITY_BEHAVIOR_IGNORE_CHANNEL: "持续施法中可用",
		...
		DOTA_UNIT_TARGET_FLAG_NOT_DOMINATED: "不可支配",
		...
		DOTA_UNIT_TARGET_FLAG_NOT_SUMMONED: "非召唤单位",
		...
		MODIFIER_PROPERTY_ABSORB_SPELL: "法术抵抗（类似林肯法球）",
		MODIFIER_PROPERTY_ATTACK_RANGE_BONUS: "攻击范围奖励",
		MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT: "修改攻击速度",
		MODIFIER_PROPERTY_AVOID_DAMAGE: "物理闪避几率",
		MODIFIER_PROPERTY_AVOID_SPELL: "法术闪避几率",
		...
		MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE: "百分比奖励视野",
		MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE: "改变技能数值",
		MODIFIER_PROPERTY_COOLDOWN_REDUCTION_CONSTANT: "减少技能和物品冷却时间，正降负升",
		...
		MODIFIER_PROPERTY_EVASION_CONSTANT: "闪避几率，正降负升",
		...
		MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP: "强制显示在小地图",
		MODIFIER_PROPERTY_HEALTH_BONUS: "生命值奖励",
		MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT: "固定的生命回复数值",
		MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE: "基于最大生命值百分比的生命恢复",
		MODIFIER_PROPERTY_IGNORE_CAST_ANGLE: "忽略施法面向",
		...
		MODIFIER_PROPERTY_MANA_REGEN_CONSTANT: "固定的魔法回复数值",
		MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE: "固定的魔法回复数值，不可叠加",
		MODIFIER_PROPERTY_MANA_REGEN_PERCENTAGE: "基于基础魔法恢复值百分比的魔法恢复",
		MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE: "基于最大魔法值百分比的魔法恢复",
		MODIFIER_PROPERTY_MIN_HEALTH: "生命值不小于",
		MODIFIER_PROPERTY_MISS_PERCENTAGE: "MISS几率",
		MODIFIER_PROPERTY_MODEL_CHANGE: "设定模型",
		MODIFIER_PROPERTY_MODEL_SCALE: "模型大小",
		...
		MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE: "冷却时间百分比（正降负升）",
		...
		MODIFIER_PROPERTY_MANACOST_PERCENTAGE: "百分比降低魔法消耗（不支持负数）",
		...
		DisableDamageDisplay: "禁用伤害显示",
		Skin: "皮肤",
		DisableWearables: "禁用饰品",
